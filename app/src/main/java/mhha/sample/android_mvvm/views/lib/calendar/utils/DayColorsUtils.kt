...
import mhha.sample.android_mvvm.views.lib.calendar.CalendarDay
...
fun TextView.setDayColors(
    ...
    backgroundRes: Int = R.drawable.shape_transparent
) {
...
fun setSelectedDayColors(
    dayLabel: androidx.appcompat.widget.AppCompatTextView,
    calendar: Calendar,
...
fun setCurrentMonthDayColors(
    ...
    if (calendar.get(Calendar.DAY_OF_WEEK) == Calendar.SUNDAY) {
        dayLabel.setDayColors(
            ...
            backgroundRes = R.drawable.shape_transparent
        )
    }
...
private fun setTodayColors(
    ...
    if (calendarDayBackgroundRes != null) {
        ...
        dayLabel.setDayColors(
            textColor = calendarProperties.todayLabelColor,
            typeface = calendarProperties.todayTypeface,
            backgroundRes = R.drawable.circle
        )
    }
...
private fun setNormalDayColors(
    ...
    when {
        ...
        calendarDayBackgroundDrawable != null -> {
            ...
            dayLabel.setDayColors(labelColor, backgroundRes = R.drawable.shape_transparent)
        }
    }
}
