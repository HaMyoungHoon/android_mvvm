package mhha.sample.android_mvvm.views.lib.calendar.adapters
...
import mhha.sample.android_mvvm.views.lib.calendar.extensions.*
...
class CalendarPageAdapter(
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        calendarGridView.onItemClickListener =
            DayRowClickListener(calendarView, this, calendarProperties, pageMonth)
